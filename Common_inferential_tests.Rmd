...
t.test(W, mu=2,alternative = "greater")
...
qt(c(0.005, 0.01, 0.015, 0.02, 0.025),df=9)
...
for (i in 1:10000) {
    N[i] <- mean(rnorm(i, 1.5, 0.7905694))/(0.7905694/sqrt(5))
}



for (i in 1:10000) {
    M[i] <- a + mean(rnorm(i, 1.5, 0.7905694))/(0.7905694/sqrt(5))
}
print(M)
